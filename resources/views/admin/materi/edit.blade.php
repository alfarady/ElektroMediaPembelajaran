...
<div class="card">
    ...
    <div class="card-body">
        {!! Form::open(['url' => action('MateriController@update', $data->id), 'method' => 'post', 'id' => 'submitForm', 'files' => true]) !!}
        @method('PUT')
        ...
        <div class="input-group mb-2 mr-sm-2">
            {!! Form::text('indikator[]', $data->indikator[0], 
        ...
        <div class="indikator_field">
            @foreach ($data->indikator as $key => $item)
                ...
                @endif
                <div class="input-group mb-2 mr-sm-2">
                    {!! Form::text('indikator[]', $item, 
                        ['id' => 'indikator', 'class' => 'form-control', 'required', 'placeholder' => 'Ketik indikator', 'required']); 
                    !!}
                    <div class="input-group-prepend decrease_indikator" style="cursor: pointer">
                    <div class="input-group-text">-</div>
                    </div>
                </div>
            @endforeach
        ...
        <div class="form-group">
            ...
            {!! Form::hidden('materi', $data->materi, ['id' => 'materi']) !!}
...
$( document ).ready(function() {
    ...
    quill.root.innerHTML = document.getElementById('materi').value;
