            ...
            <table class=" table table-bordered table-striped table-hover datatable">
                ...
                @endphp
                    ...
                    <tr data-entry-id="{{ $value->id }}">
                        ...
                        <td>
                            <i class="fa fa-edit fa-lg edit_action" href="{{ action('Admin\SubdistrictController@edit', $value->id) }}" style="cursor:pointer;margin-right:10px;" data-toggle="tooltip" title="Edit"></i>
                            <i class="fa fa-trash fa-lg delete_action" href="{{ action('Admin\SubdistrictController@destroy', $value->id) }}" style="cursor:pointer;margin-right:10px;" data-toggle="tooltip" title="Hapus"></i>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
