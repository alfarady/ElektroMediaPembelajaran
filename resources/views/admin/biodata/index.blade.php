...
<div class="card">
    <div class="card-header">
        ...
        <button type="button"
            ...
            data-href="{{action('BiodataController@create')}}"
            data-container=".add_form">{{ __('Tambah Biodata') }}</button>
    </div>
            ...
            <table class=" table table-bordered table-striped table-hover datatable">
                ...
                <tbody>
                    ...
                    <tr data-entry-id="{{ $value->id }}">
                        ...
                        <td>
                            <i class="fa fa-edit fa-lg edit_action" href="{{ action('BiodataController@edit', $value->id) }}" style="cursor:pointer;margin-right:10px;"></i>
                            <i class="fa fa-trash fa-lg delete_action" href="{{ action('BiodataController@destroy', $value->id) }}" style="cursor:pointer;margin-right:10px;"></i>
                        </td>
                    </tr>
                    @endforeach
                </tbody>
